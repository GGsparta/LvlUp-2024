...
public partial class @InputMap: IInputActionCollection2, IDisposable
{
    ...
    ~@InputMap()
    {
        UnityEngine.Debug.Assert(!m_Gameplay2D.enabled, "This will cause a leak and performance issues, InputMap.Gameplay2D.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Gameplay3D.enabled, "This will cause a leak and performance issues, InputMap.Gameplay3D.Disable() has not been called.");
    }
